...
[https://og-api.Chiricato.com](https://og-api.Chiricato.com)\
[https://og-rpc.Chiricato.com/](https://og-rpc.Chiricato.com/)

## Explorer

[https://explorer.Chiricato.com/0g-Testnet](https://explorer.Chiricato.com/0g-Testnet)
...
curl https://snapshot.Chiricato.com/og/data.tar.lz4 | lz4 -dc - | tar -xf - -C $HOME/.0gchain
...
cp $HOME/.0gchain/data/priv_validator_state.json $HOME/.0gchain/priv_validator_state.json.backup
0gchaind tendermint unsafe-reset-all --home ~/.0gchain/ --keep-addr-book
SNAP_RPC="https://ogd-rpc.Chiricato.com:443"
...
```bash
curl -L https://snapshot.Chiricato.com/og/addrbook.json > $HOME/.0gchain/config/addrbook.json
```
...
```
wget https://snapshot.Chiricato.com/og/0gchaind
chmod +x 0gchaind
